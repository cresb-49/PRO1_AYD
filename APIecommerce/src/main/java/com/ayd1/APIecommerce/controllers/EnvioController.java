...
public class EnvioController {
    ...
    @Operation(summary = "Obtener un envio por ID",
            description = "Devuelve los detalles de un envio específico según su ID.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getEnvio(
            @Parameter(description = "ID del envio a buscar",
    ...
    @Operation(summary = "Obtener los envios exitentes segun su estado (PENDIENTE, ENTREGADO)",
            description = "Devuelve los detalles de los envios existentes filtrados por su estado.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Envio obtenido exitosamente",
                content = @Content(mediaType = "application/json",
                        array = @ArraySchema(
    ...
    public ResponseEntity<?> getEnviosFiltrados(
            @Parameter(description = "Estado de los envios",
                    required = true) @PathVariable String estado) {
        try {
    ...
    @Operation(summary = "Actualizar el estado del envio",
            description = "Actualiza el estado de entrega de un envio, si el "
    ...
    public ResponseEntity<?> actualizarEnvio(
            @Parameter(description = "ID del envio a actualizar su estado",
                    required = true) @PathVariable Long id) {
        try {
